...
const projects = [
  ...
  },
  {
    ...
    description: 'Responsive website for showcasing Kivu River and Karongi services.',
  ...
  },
  {
    ...
    description: 'An online store for selling products with shopping cart functionality.',
  ...
  },
  {
    ...
    description: 'Manage your tasks efficiently with options to add, delete, and mark them as complete.',
  ...
  },
  {
    ...
    description: 'Showcase your photo collection with a beautiful, responsive gallery layout.',
  ...
  },
  {
    ...
    description: 'An intuitive application assistant enhancing product design workflows with seamless UX/UI and collaboration tools',
    github: 'https://github.com/habyarimanacaleb/',
  ...
  },
  {
    ...
    description: 'A personal portfolio with dynamic animations using React and framer-motion.',
    ...
    <section id="projects" className="py-20 bg-white">
      ...
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg text-gray-700 mb-10">
          Check out the design and prototype of one of my projects created in Figma. Click on the iframe to view the full prototype.
        </p>
        <div className="figma-embed">
          <iframe
            title="Figma Design"
            src="https://www.figma.com/embed?embed_host=share&url=your-figma-url-here"
